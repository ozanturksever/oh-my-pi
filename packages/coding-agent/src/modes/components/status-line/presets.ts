...
export const STATUS_LINE_PRESETS: Record<StatusLinePreset, PresetDef> = {
	default: {
		...
		leftSegments: ["pi", "model", "plan_mode", "follow_loop", "path", "git", "context_pct", "token_total", "cost"],
		rightSegments: [],
	...
	minimal: {
		...
		rightSegments: ["plan_mode", "follow_loop", "context_pct"],
		separator: "slash",
		segmentOptions: {
	...
	compact: {
		leftSegments: ["model", "plan_mode", "follow_loop", "git"],
	...
	full: {
		leftSegments: ["pi", "hostname", "model", "plan_mode", "follow_loop", "path", "git", "subagents"],
	...
	nerd: {
		...
		leftSegments: ["pi", "hostname", "model", "plan_mode", "follow_loop", "path", "git", "session", "subagents"],
		rightSegments: [
			"token_in",
			"token_out",
			"cache_read",
	...
	ascii: {
		...
		leftSegments: ["model", "plan_mode", "follow_loop", "path", "git"],
