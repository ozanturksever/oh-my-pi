...
```bash
# Source install (Bun)
curl -fsSL https://raw.githubusercontent.com/ozanturksever/oh-my-pi/main/scripts/install.sh | sh -s -- --source

# Install release tag via binary
curl -fsSL https://raw.githubusercontent.com/ozanturksever/oh-my-pi/main/scripts/install.sh | sh -s -- --binary --ref v3.20.1

# Install branch/commit via source
curl -fsSL https://raw.githubusercontent.com/ozanturksever/oh-my-pi/main/scripts/install.sh | sh -s -- --source --ref main
```
...
```bash
mise use -g github:ozanturksever/oh-my-pi
```
